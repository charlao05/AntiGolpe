...
from backend.tests.provider_gate.guard import ExternalProviderNotAuthorized, require_authorization
...
def test_04_global_spend_limit_blocks_before_provider_execution():
    ...
    # A prior recorded call consumes the entire global ceiling.
    first_provider = MockProvider(estimate=0.10, response=ProviderResponse("ok", input_tokens=10, output_tokens=10))
